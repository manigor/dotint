...
$user["user_clinics"] = $user_clinics;
...
<tr>
    <td align="left">* <?php echo $AppUI->_('Required Fields'); ?></td>
    <td></td>
</tr>
<tr>
    <td align="right"> &nbsp;</td>
...
<?php if ($canEdit) { ?>
<tr>
    <td align="right" valign="top">* <?php echo $AppUI->_('Centers');?>:</td>
    <td>
<?php
    echo arraySelectCheckBox( $centers, 'user_clinics[]', 'class=text size=1', $user["user_clinics"] );
?>
    </td>
</tr>
<?php } ?>
