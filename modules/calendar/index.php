...
$titleBlock = new CTitleBlock( 'Monthly Calendar', '', $m, "$m.$a" );
//$titleBlock->addCell( $AppUI->_('Company').':' );
//$titleBlock->addCell( $AppUI->_('The calendar will list all upcoming visits, appointments, and events scheduled by users' ) );
echo '<br/>' . $AppUI->_('The calendar will list all upcoming visits, appointments, and events scheduled by users' );
echo '<br/>' . $AppUI->_('This will include the different types of client visits and any other event scheduled with the system');
