...
*/
//$ttl = "$type :: ";
$ttl .= $client_id > 0 ? "Edit Medical Admission" : "New Medical Admission";
   ...
   <td align="left">
	<tr>
	  <td>
        ...
        <tr>
			<td align="right"><?php echo $AppUI->_('Clinic');?>: </td>
			<td>
...
<?php
	if (isset($_GET['tab']))
		$AppUI->setState('MedicalAdmissionAeTabIdx', dPgetParam($_GET, 'tab', 0));

		$moddir = $dPconfig['root_dir'] . '/modules/clinical/';	
	...
	$tabBox->loadExtras('clinical', 'add');
	$tabBox->show('', true);
?>
</td>
</table>
