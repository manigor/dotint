...
{
	$sql = 'SELECT * FROM client_medical_info WHERE medical_client_id = ' . $client_id;

	//$medical_info_id  = db_exec($sql);
	//$row = new CClientCounsellingInfo();
...
//var_dump($row->medical_building_solution_id);
...
<form name="counsellingInfoFrm" action="?m=clients&a=addedit&client_id=<?php echo $client_id; ?>" method="post">
  ...
  <input type="hidden" name="medical[medical_info_id]" value="<?php echo $row->counsel_info_id;?>" />
  <input type="hidden" name="medical[medical_client_id]" value="<?php echo $client_id;?>" />
  <input type="hidden" name="medical[medical_firewall_contact]" id="medical_firewall_contact" value="<?php echo @$row->medical_firewall_contact;?>" />
  <input type="hidden" name="medical[medical_vpn_contact]" id="medical_vpn_contact" value="<?php echo @$row->medical_vpn_contact;?>" />
...
<tr>
    <td colspan="2" valign="top">
      ...
      <tr>
		 ...
		 <td align="left">&nbsp;&nbsp;<?php echo arraySelectRadio($boolTypes, "medical[medical_place_of_birth]", 'onclick=toggleButtons()', $row->medical_place_of_birth ? $row->medical_place_of_birth : -1, $identifiers ); ?></td>		
      </tr>
      <tr>
		 <td align="left"><?php echo $AppUI->_('Area');?>:</td>
		 <td align="left">
	    <input type="text" class="text" name="medical[medical_birth_area]" value="<?php echo @$row->medical_birth_area;?>" maxlength="150" size="20" />
		 </td>
      </tr>
	 <tr>
		<td align="left"><?php echo $AppUI->_('Mode of birth');?>:</td>
		<td align="left">&nbsp;&nbsp;<input type="text" class="text" name="medical[medical_mode_birth]" id="medical_gestation_period" value="<?php echo $obj->medical_mode_birth;?>" maxlength="150" size="20"/></td>
     </tr>	 
	 <tr>
		<td align="left"><?php echo $AppUI->_('Gestation period (months)');?>:</td>
		<td align="left">&nbsp;&nbsp;<input type="text" class="text" name="medical[medical_gestation_period]" id="medical_gestation_period" value="<?php echo $obj->medical_gestation_period;?>" maxlength="150" size="20"/></td>
     </tr>	 	  
	   <tr>
	 ...
	 <td align="left"><?php echo $AppUI->_('Body site');?>:</td>
      ...
      <tr>
			...
			<table>
			 <tr>
			  ...
			  <td>
			  <input type="text" class="text" name="medical[medical_tb_date1]" id="medical_tb_date2" value="<?php echo $obj->medical_tb_date2;?>" maxlength="150" size="20"/>&nbsp;yyyy-mm-dd<br/>
			  </td>
	          </tr>
			 <tr>
			  <td>
	  ...
	  <tr>
		...
		<table>
		  ...
		  <td>&nbsp;&nbsp;<?php echo arraySelectRadio($boolTypes, "medical[medical_pneumonia]", 'onclick=toggleButtons()', $row->medical_pneumonia ? $row->medical_pneumonia : -1, $identifiers ); ?></td>
		  </tr>
		<tr><td><?php echo $AppUI->_('Diarrhoeal episodes');?>:</td><td>&nbsp;&nbsp;<?php echo arraySelectRadio($boolTypes, "medical[medical_diarrhoea]", 'onclick=toggleButtons()', $row->medical_diarrhoea ? $row->medical_diarrhoea : -1, $identifiers ); ?></td></tr>
		<tr><td><?php echo $AppUI->_('Skin rashes');?>:</td><td>&nbsp;&nbsp;<?php echo arraySelectRadio($boolTypes, "medical[medical_skin_rash]", 'onclick=toggleButtons()', $row->medical_skin_rash ? $row->medical_skin_rash : -1, $identifiers ); ?></td></tr>
		<tr><td><?php echo $AppUI->_('Ear discharge');?>:</td><td>&nbsp;&nbsp;<?php echo arraySelectRadio($boolTypes, "medical[medical_ear_discharge]", 'onclick=toggleButtons()', $row->medical_ear_discharge ? $row->medical_ear_discharge : -1, $identifiers ); ?></td></tr>
		<tr><td><?php echo $AppUI->_('Fever ');?>:</td><td>&nbsp;&nbsp;<?php echo arraySelectRadio($boolTypes, "medical[medical_fever]", 'onclick=toggleButtons()', $row->medical_fever ? $row->medical_fever : -1, $identifiers ); ?></td></tr>
		<tr><td><?php echo $AppUI->_('Persistent oral thrush');?>:</td><td>&nbsp;&nbsp;<?php echo arraySelectRadio($boolTypes, "medical[medical_oral_rush]", 'onclick=toggleButtons()', $row->medical_oral_rush ? $row->medical_oral_rush : -1, $identifiers ); ?></td></tr>
		<tr><td><?php echo $AppUI->_('Mouth ulcers');?>:</td><td>&nbsp;&nbsp;<?php echo arraySelectRadio($boolTypes, "medical[medical_mouth_ulcers]", 'onclick=toggleButtons()', $row->medical_mouth_ulcers ? $row->medical_mouth_ulcers : -1, $identifiers ); ?></td></tr>
		</table>
		</td>
     </tr>	  
	 <tr>
		<td align="left" valign="top"><?php echo $AppUI->_('Malnutrition');?>:</td>
		<td align="left" valign="top">&nbsp;&nbsp;<?php echo arraySelectRadio($malnutritionType, "medical[medical_malnutrition]", 'onclick=toggleButtons()', $row->medical_malnutrition ? $row->medical_malnutrition : -1, $identifiers ); ?></td>
     </tr>	  
	 <tr>	
	<td align="left" valign="top"><?php echo $AppUI->_('Previous nutritional rehabilitation?');?>:</td>
		<td align="left" valign="top">&nbsp;&nbsp;<?php echo arraySelectRadio($boolTypes, "medical[medical_prev_nutrition]", 'onclick=toggleButtons()', $row->medical_prev_nutrition ? $row->medical_prev_nutrition : -1, $identifiers ); ?></td>
     </tr>
	 <tr>
   ...
   <table border="0" cellpadding="1" cellspacing="1" class="details" width="100%">
	...
	<tr>
	  ...
	  <tr>
        ...
        <td align="left">
            <input type="text" class="text" name="medical[medical_weight]" value="<?php echo dPformSafe(@$obj->medical_weight);?>" maxlength="30" size="10" />
        </td>
      </tr>
      <tr>
			<td align="left"><?php echo $AppUI->_('Height (cm)');?>:</td>
			<td align="left" valign="top"><input type="text" class="text" name="medical[medical_height]" id="medical_height" value="<?php echo $obj->medical_height;?>" maxlength="30" size="10"/></td>
      </tr>
      <tr>
			<td align="left"><?php echo $AppUI->_('z score');?>:</td>
			<td align="left" valign="top"><input type="text" class="text" name="medical[medical_zscore]" id="medical_zscore" value="<?php echo $obj->medical_zscore;?>" maxlength="30" size="10"/></td>
      </tr>      <tr>
			<td align="left"><?php echo $AppUI->_('MUAC (mm) ');?>:</td>
			<td align="left" valign="top"><input type="text" class="text" name="medical[medical_muac]" id="medical_muac" value="<?php echo $obj->medical_muac;?>" maxlength="30" size="10"/></td>
      </tr>
      <tr>
			<td align="left"><?php echo $AppUI->_('Head Circum (cm)');?>:</td>
			<td align="left" valign="top"><input type="text" class="text" name="medical[medical_hc]" id="medical_hc" value="<?php echo $obj->medical_hc;?>" maxlength="30" size="10"/></td>
      </tr>
      <tr>
      ...
      <tr>
			...
			<td align="left" valign="top"><input type="text" class="text" name="medical[medical_temp]" id="medical_temp" value="<?php echo $obj->medical_temp;?>" maxlength="30" size="10"/></td>
      </tr>
      <tr>
      ...
      <tr>
			...
			<td align="left" valign="top">&nbsp;&nbsp;<?php echo arraySelectRadio($boolTypes, "medical[medical_mother_pmtct]", 'onclick=toggleButtons()', $row->medical_mother_pmtct ? $row->medical_mother_pmtct : -1, $identifiers ); ?></td>     
      </tr>
      <tr>
	  ...
	  <tr>
			...
			<?php echo $AppUI->_('Old lesions');?>:&nbsp;&nbsp;<input type="text" class="text" name="medical[medical_oldlesions]" id="medical_oldlesions" value="<?php echo $obj->medical_oldlesions;?>" maxlength="30" size="10"/>
			<?php echo $AppUI->_('Current lesions');?>:&nbsp;&nbsp;<input type="text" class="text" name="medical[medical_currentlesions]" id="medical_currentlesions" value="<?php echo $obj->medical_currentlesions;?>" maxlength="30" size="10"/>
			</td>     
      </tr>
	<tr>
			<td colspan="2" align="left">
			...
			<?php echo $AppUI->_('heart rate');?>:
			   ...
			   <td>
			    <input type="text" class="text" name="medical[medical_heartrate]" id="medical_heartrate" value="<?php echo $obj->medical_heartrate;?>" maxlength="30" size="10"/>
			</td>
			      </tr>
	<tr>
			<td>
	...
	<tr>		
	  ...
	  <tr>		
	 	<td>
			...
			<td>
			<input type="text" class="text" name="medical[medical_location]" id="medical_location" value="<?php echo $obj->medical_location;?>" maxlength="30" size="10"/>
			</td>
	      </tr>	  
		  <tr>		
	 	 <td>
		  ...
		  <tr>		
			...
			<td>
			<input type="text" class="text" name="medical[medical_breathlocation]" id="medical_breathlocation" value="<?php echo $obj->medical_breathlocation;?>" maxlength="30" size="10"/>
			</td>
	      </tr>
	  ...
	  <input type="text" class="text" name="medical[medical_soundlocation]" id="medical_soundlocation" value="<?php echo $obj->medical_soundlocation;?>" maxlength="30" size="10"/>
			</td>     
      </tr>
	  <tr>
			<td align="left">
			...
			<input type="text" class="text" name="medical[medical_pulserate]" id="medical_pulserate" value="<?php echo $obj->medical_pulserate;?>" maxlength="30" size="10"/>
			</td>
      </tr>
	  <tr>
	  ...
	  <tr>
		  ...
		  <tr>		
			...
			<td>
			<input type="text" class="text" name="medical[medical_heart_type]" id="medical_heart_type" value="<?php echo $obj->medical_heart_type;?>" maxlength="30" size="10"/>
			</td>     
      </tr>
	<tr>
			<td colspan="2" align="left">
	...
	<tr>		
	  ...
	  <tr>
			...
			<td>
			<input type="text" class="text" name="medical[medical_liver_costal]" id="medical_liver_costal" value="<?php echo $obj->medical_liver_costal;?>" maxlength="30" size="10"/>
						</td>
      </tr>
	<tr>
						<td>
		...
		<td>
			<input type="text" class="text" name="medical[medical_spleen_costal]" id="medical_spleen_costal" value="<?php echo $obj->medical_spleen_costal;?>" maxlength="30" size="10"/>
			</td>     
      </tr>
	  <tr>
			<td align="left" valign="top">
			...
			<td>		  
		  <input type="text" class="text" name="medical[medical_masses]" id="medical_masses" value="<?php echo $obj->medical_masses;?>" maxlength="30" size="10"/>
						</td>
      </tr>
	<tr>
						<td>
	  ...
	  <tr>
			...
			<tr>		
				...
				<td>
					<?php echo arraySelectRadio($boolTypes, "medical[medical_mother_pmtct]", 'onclick=toggleButtons()', $row->medical_mother_pmtct ? $row->medical_mother_pmtct : -1, $identifiers ); ?>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="text" class="text" name="medical[medical_hc]" id="medical_hc" value="<?php echo $obj->medical_hc;?>" maxlength="30" size="10"/>
						</td>
				</tr>
			<tr>		
				<td>
      ...
      <tr>
			...
			<td align="left" valign="top">
			<?php echo arraySelectRadio($boolTypes, "medical[medical_mother_pmtct]", 'onclick=toggleButtons()', $row->medical_mother_pmtct ? $row->medical_mother_pmtct : -1, $identifiers ); ?></td>     
      </tr>
	  	<tr>
			<td colspan="2" align="left">
	...
	<tr>
	  ...
	  <tr>
			...
			<td>
			<input type="text" class="text" name="medical[medical_abnormal_movts]" id="medical_abnormal_movts" value="<?php echo $obj->medical_abnormal_movts;?>" maxlength="30" size="10"/>
						</td>
	...
	<td>	
			...
			<td>
			<input type="text" class="text" name="medical[medical_movts_impaired_desc]" id="medical_movts_impaired_desc" value="<?php echo $obj->medical_movts_impaired_desc;?>" maxlength="30" size="10"/>
			</td>     
      </tr>	  
	  <tr>
			<td align="left" valign="top">
	...
	<tr>			
			...
			<td>
			<input type="text" class="text" name="medical[medical_joints_swelling_desc]" id="medical_joints_swelling_desc" value="<?php echo $obj->medical_joints_swelling_desc;?>" maxlength="30" size="10"/>
			</td>     
      </tr>	  
	...
	<tr>		
			...
			<td>
			<input type="text" class="text" name="medical[medical_cd4]" id="medical_cd4" value="<?php echo $obj->medical_cd4;?>" maxlength="30" size="10"/>
						</td>
	    </tr>
	<tr>				
			<td>
			...
			<td>
			<input type="text" class="text" name="medical[medical_cd4_percentage]" id="medical_cd4_percentage" value="<?php echo $obj->medical_cd4_percentage;?>" maxlength="30" size="10"/>
			</td>     
      </tr>	 
	  <tr>
			<td align="left" valign="top">
			...
			<td>
			<input type="text" class="text" name="medical[medical_who_clinical_stage]" id="medical_who_clinical_stage" value="<?php echo $obj->medical_who_clinical_stage;?>" maxlength="30" size="10"/>
						</td>
    </tr>
	<tr>				
		<td>
			...
			<td>
			<input type="text" class="text" name="medical[medical_immuno_stage]" id="medical_immuno_stage" value="<?php echo $obj->medical_immuno_stage;?>" maxlength="30" size="10"/>
			</td>     
      </tr>	 
	  <tr>
			<td align="left" valign="top">
			...
			<td>
			<input type="text" class="text" name="medical[medical_tests]" id="medical_tests" value="<?php echo $obj->medical_tests;?>" maxlength="30" size="10"/>
						</td>
			    </tr>
	       <tr>		
			<td>
			...
			<td>
			<input type="text" class="text" name="medical[medical_referral]" id="medical_referral" value="<?php echo $obj->medical_referral;?>" maxlength="30" size="10"/>
			</td>     
      </tr>	 
	 <tr>
	 ...
	 <tr>
	    ...
	    <td align="left">
          <input type="text" class="text" name="clinical_clinician" value="<?php echo dPformSafe(@$clientObj->client_adm_no);?>" maxlength="150" size="20" disabled  readonly="readonly" />
         </td>
