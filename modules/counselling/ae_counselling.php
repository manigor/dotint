...
<tr>
    <td colspan="2" valign="top">
     ...
     <tr>
		...
		<td align="left">
		<input type="text" class="text" name="client_code" id="client_code" value="<?php echo $client_adm_no;?>" maxlength="150" size="20" disabled="disabled" />
	    </td>
...
<tr>
		...
		<td align="left">&nbsp;&nbsp;<?php echo arraySelectRadio($ageTypes, "counselling[counselling_age_status]", 'onclick=toggleButtons()', $row->counselling_age_status ? $row->counselling_age_status : -1, $identifiers ); ?></td>		
	 </tr>
    	
	<tr>
         <td align="left"><?php echo $AppUI->_('Place of Birth');?>:</td>
		 <td align="left">&nbsp;&nbsp;<?php echo arraySelectRadio($birthPlaces, "counselling[counselling_place_of_birth]", 'onclick=toggleButtons()', $row->counselling_place_of_birth ? $row->counselling_place_of_birth : -1, $identifiers ); ?></td>		
	 ...
	 <tr>
      ...
      <tr>
			...
			<td align="left">&nbsp;&nbsp;<?php echo arraySelectRadio($awareStages, "counselling[counselling_mothers_status_known]", 'onclick=toggleButtons()', $row->counselling_mothers_status_known ? $row->counselling_mothers_status_known : -1, $identifiers ); ?>
			</td>	
      </tr>
	  <tr>
