...
<form name="counsellingInfoFrm" action="?m=clients&a=addedit&client_id=<?php echo $client_id; ?>" method="post">
  ...
  <input type="hidden" name="counselling[counselling_firewall_contact]" id="counselling_firewall_contact" value="<?php echo @$row->counselling_firewall_contact;?>" />
  <input type="hidden" name="counselling[counselling_vpn_contact]" id="counselling_vpn_contact" value="<?php echo @$row->counselling_vpn_contact;?>" />
    ...
    <td colspan="2" valign="top">
     ...
     <tr>
	   ...
	   <tr>
		...
		<td align="left">&nbsp;&nbsp;<?php echo arraySelectRadio($boolTypes, "counselling[counselling_total_orphan]", 'onclick=toggleButtons()', $row->counselling_total_orphan ? $row->counselling_total_orphan : 2, $identifiers ); ?></td>
     </tr>	  
...
<tr>
		 ...
		 <td align="left">
	    <input type="text" class="text" name="counselling[counselling_age_yrs]" value="<?php echo dPformSafe(@$obj->counselling_age_yrs);?>" maxlength="30" size="15" />
		<?php echo $AppUI->_('years');?>:
		 </td>
         
		 <td align="left">
	    <input type="text" class="text" name="counselling[counselling_age_months]" value="<?php echo dPformSafe(@$obj->counselling_age_months);?>" maxlength="30" size="15" />
		<?php echo $AppUI->_('months');?>:
		 </td>
		
		<td align="left">&nbsp;&nbsp;<?php echo arraySelectRadio($ageTypes, "counselling[counselling_age_status]", 'onclick=toggleButtons()', $row->counselling_age_status ? $row->counselling_age_status : 2, $identifiers ); ?></td>		
	 </tr>
    	
	<tr>
         <td align="left"><?php echo $AppUI->_('Place of Birth');?>:</td>
		 <td align="left">&nbsp;&nbsp;<?php echo arraySelectRadio($birthPlaces, "counselling[counselling_place_of_birth]", 'onclick=toggleButtons()', $row->counselling_place_of_birth ? $row->counselling_place_of_birth : 2, $identifiers ); ?></td>		
	 ...
	 <tr>
		...
		<td align="left">&nbsp;&nbsp;<?php echo arraySelectRadio($birthTypes, "counselling[counselling_mode_birth]", 'onclick=toggleButtons()', $row->counselling_mode_birth ? $row->counselling_mode_birth : 2, $identifiers ); ?></td>		
	 ...
	 <tr>
      ...
      <tr>
			...
			<td align="left">&nbsp;&nbsp;<?php echo arraySelectRadio($awareStages, "counselling[counselling_mothers_status_known]", 'onclick=toggleButtons()', $row->counselling_mothers_status_known ? $row->counselling_mothers_status_known : 2, $identifiers ); ?>
			</td>	
      </tr>
	  <tr>
		<td align="left"><?php echo $AppUI->_('Did mother receive any antenatal care?');?>:</td>
		<td align="left">&nbsp;&nbsp;<?php echo arraySelectRadio($boolTypes, "counselling[counselling_mother_antenatal]", 'onclick=toggleButtons()', $row->counselling_mother_antenatal ? $row->counselling_mother_antenatal : 2, $identifiers ); ?></td>
     </tr>	  
	 <tr>
	 ...
	 <tr>
		...
		<td align="left" valign="top">&nbsp;&nbsp;<?php echo arraySelectRadio($boolTypes, "counselling[counselling_mother_illness_pregnancy]", 'onclick=toggleButtons()', $row->counselling_mother_illness_pregnancy ? $row->counselling_mother_illness_pregnancy : 2, $identifiers ); ?></td>
   ...
   <table border="0" cellpadding="1" cellspacing="1" class="details" width="100%">
	 <tr>
		...
		<td align="left" valign="top">
			<?php echo arraySelectRadio($boolTypes, "counselling[counselling_child_perinatal]", 'onclick=toggleButtons()', $row->counselling_child_perinatal ? $row->counselling_child_perinatal : 2 ); ?>
        </td>
	</tr>
	<tr>
		...
		<td valign="top">
		<?php echo arraySelectRadio($boolTypes, "counselling[counselling_child_single_nvp]", 'onclick=toggleButtons()', $row->counselling_child_single_nvp? $row->counselling_child_single_nvp : 2 ); ?>
		</td>		
     </tr>	
	 <tr>
		...
		<td valign="top">
		<textarea cols="30" rows="5" class="textarea" name="counselling[counselling_child_nvp_notes]"><?php echo @$obj->counselling_child_nvp_notes;?></textarea>
		</td>
     </tr>
	 ...
	 <tr>
		...
		<td align="left" valign="top">
			<?php echo arraySelectRadio($boolTypes, "counselling[counselling_child_azt]", 'onclick=toggleButtons()', $row->counselling_child_azt? $row->counselling_child_azt : 2); ?>
        </td>
	 </tr>	 
	 <tr>
	 ...
	 <tr>
		...
		<td align="left" >&nbsp;&nbsp;
			<?php echo arraySelectRadio($boolTypes, "counselling[counselling_mother_treatment]", 'onclick=toggleButtons()', $row->counselling_mother_treatment ? $row->counselling_mother_treatment : 2 ); ?>
        </td>
	 </tr>	 
	 <tr>
		<td align="left" valign="top"><?php echo $AppUI->_('Mother on ART in pregnancy');?>:</td>
		<td align="left" valign="top">&nbsp;&nbsp;
			<?php echo arraySelectRadio($boolTypes, "counselling[counselling_mother_art_pregnancy]", 'onclick=toggleButtons()', $row->counselling_mother_art_pregnancy ? $row->counselling_mother_art_pregnancy : 2 ); ?>
        </td>
     </tr>	 
	 <tr>
	...
	<tr>
			<td colspan="2" align="center" nowrap>
				<img src="images/shim.gif" width="50" height="1" /><?php echo $AppUI->_('PCR Tests'); ?><br />
	 ...
	 <tr>
		...
		<td align="left">&nbsp;&nbsp;<input type="text" class="text" name="counselling[counselling_bioline]" id="counselling_bioline" value="<?php echo $obj->counselling_bioline;?>" maxlength="150" size="20"/>&nbsp;yyyy-mm-dd</td>
	 </tr>
	 <tr>
		...
		<td align="left">&nbsp;&nbsp;<input type="text" class="text" name="counselling[counselling_unigold]" id="counselling_unigold" value="<?php echo $obj->counselling_unigold;?>" maxlength="150" size="20"/>&nbsp;yyyy-mm-dd</td>
	 </tr>
	 <tr>
		...
		<td align="left">&nbsp;&nbsp;<input type="text" class="text" name="counselling[counselling_elisa]" id="counselling_elisa" value="<?php echo $obj->counselling_elisa;?>" maxlength="150" size="20"/>&nbsp;yyyy-mm-dd</td>
	 </tr>
	 <tr>
		...
		<td align="left">&nbsp;&nbsp;<input type="text" class="text" name="counselling[counselling_pcr1]" id="counselling_pcr1" value="<?php echo $obj->counselling_pcr1;?>" maxlength="150" size="20"/>&nbsp;yyyy-mm-dd</td>
	 </tr>
	 <tr>
		...
		<td align="left">&nbsp;&nbsp;<input type="text" class="text" name="counselling[counselling_pcr2]" id="counselling_pcr2" value="<?php echo $obj->counselling_pcr2;?>" maxlength="150" size="20"/>&nbsp;yyyy-mm-dd</td>
	 </tr>
	 <tr>
		...
		<td align="left">&nbsp;&nbsp;<input type="text" class="text" name="counselling[counselling_rapid12]" id="counselling_rapid12" value="<?php echo $obj->counselling_rapid12;?>" maxlength="150" size="20"/>&nbsp;yyyy-mm-dd</td>
	 </tr>
	 <tr>
		...
		<td align="left">&nbsp;&nbsp;<input type="text" class="text" name="counselling[counselling_rapid18]" id="counselling_rapid18" value="<?php echo $obj->counselling_rapid18;?>" maxlength="150" size="20"/>&nbsp;yyyy-mm-dd</td>
	 </tr>
	 <tr>
		...
		<td align="left">&nbsp;&nbsp;<input type="text" class="text" name="counselling[counselling_other]" id="counselling_other" value="<?php echo $obj->counselling_other;?>" maxlength="150" size="20"/>&nbsp;yyyy-mm-dd</td>
	 </tr>
<tr>
