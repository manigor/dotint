<?php /* FILES $Id: do_file_aed.php,v 1.18.6.5 2006/03/04 08:07:37 gregorerhardt Exp $ */
//addfile sql
...
$obj->file_category = intval( dPgetParam( $_POST, 'file_category', 2 ) );
...
if($suppressHeaders){
	...
	$AppUI->redirect('m=manager&a=view_imp&file_id='.$obj->file_id);
}
?>
