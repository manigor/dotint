...
if (in_array($pway,$tvar)) {
	...
	*/
	...
	$iter=0;
	$last=false;
	$headers = array ('client_adm_no', 'client_first_name', 'client_other_name', 'client_last_name', 'clinic_name', 'medical_id', 'medical_staff_id', 
					  'medical_staff_name', 'contact_first_name', 'contact_other_name', 'contact_last_name', 'medical_clinic_id', 'medical_gender', 
					  'medical_age_yrs', 'medical_age_months', 'medical_entry_date', 'medical_birth_location', 'medical_delivery', 'medical_birth_problems', 
					  'medical_transferred', 'medical_other_programme', 'medical_birth_weight', 'medical_pmtct', 'medical_mother_arv_given', 
					  'medical_child_arv_given', 'medical_immunization_status', 'medical_card_seen', 'medical_breastfeeding', 'medical_exclusive_breastfeeding', 
					  'medical_bf_duration', 'medical_father_hiv_status', 'medical_father_arv', 'medical_mother_hiv_status', 'medical_mother_arv', 
					  'medical_no_siblings_alive', 'medical_no_siblings_deceased', 'medical_tb_contact', 'medical_tb_contact_person', 'medical_tb_date_diagnosed', 
					  'medical_tb_pulmonary', 'medical_tb_type', 'medical_tb_type_desc', 'medical_tb_bodysite', 'medical_tb_date1', 'medical_tb_date2', 
					  'medical_tb_date3', 'medical_history_pneumonia', 'medical_history_diarrhoea', 'medical_history_skin_rash', 'medical_history_ear_discharge', 
					  'medical_history_fever', 'medical_history_oral_rush', 'medical_history_mouth_ulcers', 'medical_history_malnutrition', 
					  'medical_history_prev_nutrition', 'medical_history_notes', 'medical_arv_status', 'medical_arv1', 'medical_arv1_startdate',
					  'medical_arv1_enddate', 'medical_arv2', 'medical_arv2_startdate', 'medical_arv2_enddate','medical_salvage', 'medical_salvage_startdate', 
					  'medical_salvage_enddate', 'medical_arv_side_effects', 'medical_arv_adherence', 'medical_school_attendance', 'medical_school_class', 
					  'medical_educ_progress', 'medical_sensory_hearing', 'medical_sensory_vision', 'medical_sensory_motor_ability', 'medical_sensory_speech_language', 
					  'medical_sensory_social_skills', 'medical_meals_per_day', 'medical_food_types', 'medical_current_complaints', 'medical_weight', 'medical_height', 
					  'medical_zscore', 'medical_muac', 'medical_hc', 'medical_condition', 'medical_temp', 'medical_conditions', 'medical_dehydration', 
					  'medical_parotids', 'medical_lymph', 'medical_eyes', 'medical_eyes_notes', 'medical_ear_discharge', 'medical_ear_discharge_location', 
					  'medical_throat', 'medical_mouth_thrush', 'medical_mouth_ulcers', 'medical_mouth_teeth', 'medical_oldlesions', 'medical_currentlesions', 
					  'medical_heartrate', 'medical_recession', 'medical_percussion', 'medical_location', 'medical_breath_sounds', 'medical_breathlocation', 
					  'medical_other_sounds', 'medical_soundlocation', 'medical_pulserate', 'medical_apex_beat', 'medical_precordial', 'medical_femoral', 
					  'medical_heart_sound', 'medical_heart_type', 'medical_abdomen_distended', 'medical_adbomen_feel', 'medical_abdomen_tender', 
					  'medical_abdomen_fluid', 'medical_liver_costal', 'medical_spleen_costal', 'medical_masses', 'medical_umbilical_hernia', 'medical_testes', 
					  'medical_which_testes', 'medical_genitals_female_notes', 'medical_genitals_feel', 'medical_penis', 'medical_genitals_female', 
					  'medical_pubertal', 'medical_gait','medical_gait_opt', 'medical_handuse','medical_handuse_opt', 'medical_weakness', 'medical_tone', 
					  'medical_tendon_legs', 'medical_tendon_arms', 'medical_abnormal_movts', 'medical_movts_impaired', 'medical_movts_impaired_desc', 
					  'medical_joints_swelling', 'medical_joints_swelling_desc', 'medical_motor','medical_motor_notes', 'medical_musc_notes', 'medical_hiv_status', 
					  'medical_cd4', 'medical_cd4_percentage', 'medical_who_clinical_stage', 'medical_immuno_stage', 'medical_tests', 'medical_referral', 
					  'medical_referral_old', 'medical_chest_shape','medical_custom','medical_heart_rate','medical_resp_rate','medical_skin_type','medical_skin_note',
					  'medical_cns','medical_cns_note','medical_muscle','medical_muscle_note','medical_request','medical_request_note','medical_next_visit', 'medical_notes' );
	...
	$headers = array ('client_adm_no', 'client_first_name', 'client_other_name', 'client_last_name', 'clinic_name', 'admission_id', 'admission_staff_id', 
					  'admission_staff_name', 'contact_first_name', 'contact_other_name', 'contact_last_name', 'admission_clinic_id', 'admission_dob', 
					  'admission_age_yrs', 'admission_age_months', 'admission_age_status', 'admission_gender', 'admission_residence', 'admission_location', 
					  'location_name', 'admission_entry_date', 'admission_school_level', 'admission_reason_not_attending', 'admission_reason_not_attending_notes', 
					  'admission_total_orphan', 'admission_province', 'admission_district', 'admission_village', 'admission_father_fname', 'admission_father_lname', 
					  'admission_father_age', 'admission_father_status', 'admission_father_health_status', 'admission_father_raising_child', 
					  'admission_father_marital_status', 'admission_father_educ_level', 'admission_father_employment', 'admission_father_income', 
					  'admission_father_idno', 'admission_father_mobile', 'admission_mother_fname', 'admission_mother_lname', 'admission_mother_age', 
					  'admission_mother_status', 'admission_mother_health_status', 'admission_mother_raising_child', 'admission_mother_marital_status', 
					  'admission_mother_educ_level', 'admission_mother_employment', 'admission_mother_income', 'admission_mother_idno', 'admission_mother_mobile', 
					  'admission_caregiver_fname', 'admission_caregiver_lname', 'admission_caregiver_age', 'admission_caregiver_status', 
					  'admission_caregiver_health_status', 'admission_caregiver_relationship', 'admission_caregiver_marital_status', 
					  'admission_caregiver_educ_level', 'admission_caregiver_employment', 'admission_caregiver_income', 'admission_caregiver_idno', 
					  'admission_caregiver_mobile', 'admission_family_income', 'admission_risk_level', 'admission_risk_level_description', 'admission_notes',
					  'admission_custom','admission_enclosures','admission_birth_cert','admission_id_no','admission_med_recs','admission_nhf',
					  'admission_immun','admission_death_cert','admission_enclosures_other' ,'admission_father','admission_mother',
					  'admission_caregiver_pri','admission_caregiver_sec','admission_caregiver_pri_relationship','admission_caregiver_sec_relationship',
					  'admission_caregiver_sec_residence','admission_chw');
	$iter=0;
	$last=false;
	$q = new DBQuery ();
	...
	$headers = array ('client_adm_no', 'client_first_name', 'client_other_name', 'client_last_name', 'household_admission_id', 'household_social_id', 
					  'household_name', 'household_yob', 'household_relationship', 'household_gender', 'household_notes','household_custom' );
	$q = new DBQuery ();
	...
	$headers = array ('client_adm_no', 'client_first_name', 'client_other_name', 'client_last_name', 'medical_history_medical_id', 'medical_history_hospital', 
					  'medical_history_date', 'medical_history_diagnosis', 'medical_history_notes','medical_history_custom' );
	$iter=0;
	$last=false;
	$q = new DBQuery ();
	...
	$headers = array ('client_adm_no', 'client_first_name', 'client_other_name', 'client_last_name', 'medications_history_drug', 'medications_history_dose', 
					  'medications_history_frequency', 'medications_history_notes','medications_history_custom' );
	$iter=0;
	$last=false;
	$q = new DBQuery ();
	...
	$headers = array ('client_adm_no', 'client_first_name', 'client_other_name', 'client_last_name', 'clinic_name', 'mortality_entry_date', 
					  'mortality_clinic_id', 'mortality_age_yrs', 'mortality_age_months', 'mortality_age_status', 'mortality_date', 
					  'mortality_death_type', 'mortality_death_type_notes', 'mortality_informant', 'mortality_hospital', 'mortality_hospital_adm_date', 
					  'mortality_relative_report_date', 'mortality_symptoms', 'mortality_time_course', 'mortality_treatment', 'mortality_referral', 
					  'mortality_hospital_referral', 'mortality_hospital_adm_notes', 'mortality_cause_given', 'mortality_cause_desc', 
					  'mortality_clinical_officer_name', 'mortality_clinical_officer_date', 'mortality_postmortem', 'mortality_cause_pm', 
					  'mortality_likely_cause', 'mortality_notes','mortality_custom','mortality_clinical_course','mortality_postmortem_where',
					  'mortality_recents_a','mortality_recents_b','mortality_malnutrition','mortality_malnutrition_notes','mortality_cd4',
					  'mortality_cd4_percentage','mortality_viral_load','mortality_hb','mortality_clinical_date','mortality_arv',
					  'mortality_arv_dateon','mortality_arv_period','mortality_tb','mortality_rb_start','mortality_weight',
					  'mortality_height','mortality_nutrition_date','mortality_enroll_date','mortality_enrolled_time','mortality_social_worker' );
	$iter=0;
	$last=false;
	$q = new DBQuery ();
	...
	$headers = array ('client_adm_no', 'client_first_name', 'client_other_name', 'client_last_name', 'clinic_name', 'dis_entry_date', 'dis_center', 'dis_time_in',
					  'dis_age_years','dis_age_months','dis_age_exact','dis_client_status','dis_status_delta_date','dis_status_mdt_date','dis_phys_address',
					  'dis_landmarks','dis_contact','dis_caregiver','dis_caregiver_relship','dis_client_health','dis_client_health_staff',
					  'dis_client_health_date','dis_client_psy','dis_client_psy_staff','dis_client_psy_date','dis_client_social','dis_client_social_staff',
					  'dis_client_social_date');
	$iter=0;
	$last=false;
	$q = new DBQuery ();
	$q->addTable ( 'discharge_info', 'di' );	
	list($discharge_records,$kheads,$repeat) = $q->loadListExport ();
	if(count($discharge_records) == 0){
		$iter=1;
		$repeat=false;
	}else{
		$clipos=array_search('dis_client_id',$kheads);
		$hospos=array_search('dis_center',$kheads);
		$conpos_health=array_search('$dis_client_health_staff',$kheads);
		$conpos_psy=array_search('$dis_client_psy_staff',$kheads);
		$conpos_social=array_search('$dis_client_social_staff',$kheads);

		while($repeat || $iter == 0 || $last === true){
			foreach ($discharge_records as $key => $vars) {
				$cclient=$clients[$vars['dis_client_id']];
				$discharge_records[$key][]=$cclient['client_adm_no'];
				$discharge_records[$key][]=$cclient['client_first_name'];
				$discharge_records[$key][]=$cclient['client_other_name'];
				$discharge_records[$key][]=$cclient['client_last_name'];
				$discharge_records[$key][]=$clinics[$vars[$hospos]]['clinic_name'];
				$cstaff=$contacts[$vars[$conpos_health]];
				$discharge_records[$key][]=$cstaff['contact_first_name'].' '.$cstaff['contact_other_name'].' '.$cstaff['contact_last_name'];
				$cstaff=$contacts[$vars[$conpos_psy]];
				$discharge_records[$key][]=$cstaff['contact_first_name'].' '.$cstaff['contact_other_name'].' '.$cstaff['contact_last_name'];
				$cstaff=$contacts[$vars[$conpos_social]];
				$discharge_records[$key][]=$cstaff['contact_first_name'].' '.$cstaff['contact_other_name'].' '.$cstaff['contact_last_name'];
			}
			//writeWorksheet ( $worksheet, $format_bold, $headers, &$discharge_records, $headers );
			$kheads=array_merge($kheads,array('client_adm_no','client_first_name','client_other_name','client_last_name','clinic_name',
						'discharge_client_health_staff_name','discharge_client_psy_staff_name','discharge_client_social_staff_name')
					);
			$mwriter->store("discharge" ,&$discharge_records,$kheads,$headers,$headers,$repeat,$iter);
			unset($discharge_records);
			if(!$last){
				list($discharge_records,$kheads,$repeat) = $q->loadListExport (null,true);
				if(count($discharge_records) > 0 && $repeat === false){
					$last=true;
				}
				++$iter;
			}else {
	...
	$iter=0;
	$last=false;
	$headers = array ('contact_first_name', 'contact_other_name', 'contact_last_name', 'contact_order_by', 'contact_title', 'contact_birthday', 'contact_job', 
					  'contact_client', 'contact_department', 'contact_type', 'contact_email', 'contact_email2', 'contact_url', 'contact_phone', 'contact_phone2', 
					  'contact_fax', 'contact_mobile', 'contact_address1', 'contact_address2', 'contact_city', 'contact_state', 'contact_zip', 'contact_country', 
					  'contact_jabber', 'contact_icq', 'contact_msn', 'contact_yahoo', 'contact_aol', 'contact_notes', 'contact_project', 'contact_icon', 
					  'contact_owner', 'contact_private', 'contact_active' );

	$q = new DBQuery ();
	$q->addTable ( 'contacts', 'con' );
	$q->leftJoin ( 'users', 'u', 'u.user_contact = con.contact_id' );
	$q->addQuery ( 'contact_first_name, contact_other_name, contact_last_name, contact_order_by, contact_title, contact_birthday, contact_job, contact_client, contact_department, 
					contact_type, contact_email, contact_email2, contact_url, contact_phone, contact_phone2, contact_fax, contact_mobile, contact_address1, contact_address2, 
					contact_city, contact_state, contact_zip, contact_country, contact_jabber, contact_icq, contact_msn, contact_yahoo, contact_aol, 
					contact_notes, contact_project, contact_icon, contact_owner, contact_private' );
	...
	$iter=0;
	$last=false;
	$headers = array ('clinic_location_clinic_id', 'clinic_name', 'clinic_location', 'clinic_location_notes','clinic_location_custom' );
	...
	$headers = array ('activity_id','activity_date', 'activity_curriculum', 'activity_curriculum_desc', 'activity_entry_date', 'activity_description', 
					  'activity_clinic', 'clinic_name', 'activity_male_count', 'activity_female_count', 'activity_notes' ,`activity_custom` , 
					  'activity_hpd','activity_visiters_total', 'activity_cadres' , 'activity_end_date');
	$iter=0;
	$last=false;
	$q = new DBQuery ();
	...
	$headers = array ('training_date', 'training_entry_date', 'training_name', 'training_clinic', 'clinic_name', 'training_notes',
						'training_curriculum','training_curriculum_desc' ,'training_custom');
	...
	$headers = array ('activity_description', 'activity_date', 'training_name','facilitator_activity_id', 'facilitator_training_id', 
					  'facilitator_training', 'facilitator_name', 'facilitator_topic', 'facilitator_custom' );
	...
	$headers = array ('activity_description', 'activity_date', 'caregiver_fname', 'caregiver_lname','caregiver_role', 'client_adm_no', 
			'client_first_name', 'client_other_name', 'client_last_name', 'activity_caregivers_activity_id', 'activity_caregivers_caregiver_id' );
	$iter=0;
	$last=false;
	$q = new DBQuery ();
	...
	$headers = array ('activity_description', 'activity_date', 'client_adm_no', 'client_first_name', 'client_other_name', 'client_last_name', 
						'activity_clients_activity_id', 'activity_clients_client_id' );
	$iter=0;
	$last=false;
	$q = new DBQuery ();
	...
	$headers = array ('activity_description', 'activity_date', 'contact_first_name', 'contact_other_name', 'contact_last_name', 
					'activity_contacts_activity_id', 'activity_contacts_contact_id' );
	...
	*/
	...
	list($sclin,$kheads) = $q->loadListExport ();
	
	if(count($sclin) == 0){
		$iter=1;
		$repeat=false;
	}else{
		$clipos=array_search('status_client_id',$kheads);		

		while($repeat || $iter == 0 || $last === true){
			foreach ($sclin as $key => $vars) {
				$cclient=$clients[$vars[$clipos]];
				$cbcinfo[$key][]=$cclient['client_adm_no'];
				$cbcinfo[$key][]=$cclient['client_first_name'];
				$cbcinfo[$key][]=$cclient['client_other_name'];
			...
			$kheads=array_merge($kheads,array('client_adm_no','client_first_name','client_other_name','client_last_name'));
			$mwriter->store("status_client" ,&$sclin,$kheads,$headers,$headers,$repeat,$iter);
			unset($sclin);
			if(!$last){
				list($sclin,$kheads,$repeat) = $q->loadListExport (null,true);
				if(count($sclin) > 0 && $repeat === false){
					$last=true;
				}
				++$iter;
			}else {
	...
	$fpath = $mwriter->close(true);
	
	/*
	Store in files table data about exported file, and copy it to system file storage	
	*/
	require_once($baseDir . '/modules/files/files.class.php');
	$obj = new CFile();
	$obj->file_name = basename($fpath);
	$obj->file_type = 'System snapshot';
	$obj->file_size = filesize($fpath);
	$obj->file_date = str_replace("'", '', $db->DBTimeStamp(time()));
	$obj->file_real_filename = uniqid( rand() );
	$obj->file_mode = 'export';
	
	$fs_stored=$obj->moveTemp(array('tmp_name'=>$fpath));
	
	$db_store=$obj->store();
	// Let's send the file
	//echo 'top usage '.bit2text(memory_get_peak_usage());
	if($fs_stored === true && is_null($db_store)){
		//echo 'ok';
		$fh=fopen($baseDir.'/modules/manager/eflag/'.$_POST['skey'],'a+');
		fclose($fh);
	}
	
	$_SESSION['export_msg']='Center '.$dPconfig['current_center'].' properly exported with '.$clientStatusCount[1].' active clients, '.
							$clientStatusCount['rest'].' not active clients, '.$clientStatusCount[9].' vct clients.<br>' ;
