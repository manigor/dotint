...
$tab = ($currentTabId) ? $currentTabId : 0;
...
$q->addTable('files', 'f');
$q->addWhere('file_mode="import"');
$q->addWhere('file_category="2"');
...
$q2->addWhere('file_mode="import"');
$q2->addWhere('file_category="2"');


$q3 = new DBQuery;
$q3->addQuery("file_id, file_version, file_version_id, file_project, file_name, file_task, file_description, file_checkout, file_co_reason, u.user_username as file_owner, file_size, file_category, file_type, file_date, cu.user_username as co_user,   contact_first_name, contact_last_name");
$q3->addTable('files');
...
$q3->addWhere('file_mode="import"');
$q3->addWhere('file_category="2"');
...
<tr>
	...
	{
		echo "\n".'<a href="./index.php?m=manager&a=maddedit_imp&file_id=' . $latest_file["file_id"] . '">';
	...
	<td nowrap="8%">
		...
		echo "
<a href=\"?m=manager&a=view_imp&file_id={$latest_file['file_id']}\" title=\"{$latest_file['file_description']}\">$filename</a>";
