...
//pager settings
$count = $obj->getCount($company_type_filter);
...
if (strncmp($currentTabName,"All Organisations", strlen("All Organisations")) == 0)
	$companiesType = false;
...
<tr>
	...
	<th nowrap="nowrap">
		<a href="?m=companies&orderby=company_name" class="hdr"><?php echo $AppUI->_('Organisation Name');?></a>
	</th>
	<th nowrap="nowrap">
...
echo "$s\n";
if ($none) {
	echo $CR . '<tr><td colspan="5">' . $AppUI->_( 'No organisations available' ) . '</td></tr>';
}
?>
</table>
<?php
