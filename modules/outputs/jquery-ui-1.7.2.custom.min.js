...
$j.fn.paletab = function(){
    var psd = $j(this).data('v2'), pct = "";
    if (!psd) {
        $j(this).css("background", "transparent").data("v2", true);
        $j("ul.topnav > li", this).each(function(){
            $j(this).attr("className", "bttab");
            var tt = $j(this).html();
            var nt = "<div class='tb0'><img src='./style/default/images/tabSelectedLeft.png' border=0></div><div class='tb1'>" +
            tt +
            "</div><div class='tb2'><img src='./style/default/images/tabSelectedRight.png' border=0></div>";
            $j(this).html(nt);
        });
    }
    else {
        $j("ul.topnav > li", this).each(function(){
            if ($j(this).hasClass('ui-tabs-selected')) {
                pct = "Selected";
            }
            else {
                pct = "";
            }
            $j("div.tb0 > img", this).attr("src", './style/default/images/tab' + pct + 'Left.png');
            $j("div.tb2 > img", this).attr("src", './style/default/images/tab' + pct + 'Right.png');
        });
    }
    return this;
}
