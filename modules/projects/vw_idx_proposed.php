...
$check = $AppUI->_('All Programmes', UI_OUTPUT_RAW);
...
<tr>
	...
	<th nowrap="nowrap">
		<a href="?m=projects&orderby=company_name" class="hdr"><?php echo $AppUI->_('Organisation');?></a>
	</th>
	<th nowrap="nowrap">
		<a href="?m=projects&orderby=project_name" class="hdr"><?php echo $AppUI->_('Programme Name');?></a>
	</th>
        <th nowrap="nowrap">
...
if ($none) {
	echo $CR . '<tr><td colspan="10">' . $AppUI->_( 'No programmes available' ) . '</td></tr>';
} else {
?>
<tr>
	<td colspan="10" align="right">
		<?php
			echo "<input type='submit' class='button' value='".$AppUI->_('Update programme status')."' />";
