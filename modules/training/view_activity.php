...
<form name="frmDelete" action="./index.php?m=activity" method="post">
...
<tr>
	<td valign="top">
		...
		<tr>
			<td align="left" nowrap="nowrap"><?php echo $AppUI->_('Activity name');?>:</td>
		...
		<tr>
			<td align="left" nowrap="nowrap"><?php echo $AppUI->_('Hours per Day');?>:</td>
		...
		<tr>
			<td align="left" nowrap="nowrap"><?php echo $AppUI->_('Total');?>:</td>
			<td class="hilite" ><?php echo $obj->activity_visiters_total;?></td>
		</tr>
		<tr>
			<td align="left" nowrap="nowrap"><?php echo $AppUI->_('Cadres trained');?>:</td>
	   ...
	   <tr>
		 ...
		 if (count($activities) > 0)
		 {
			 ...
			 <tr>
				...
				<td><?php echo $activityrecord["facilitator_topic"]?></td>
			 </tr>
			 <?php } 
