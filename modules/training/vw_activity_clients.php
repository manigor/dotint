...
<tr>
	<th nowrap="nowrap">
		<a href="?m=activity&a=view&activity_id=<?php echo $activity_id;?>&clientorderby=client_adm_no" class="hdr"><?php echo $AppUI->_('Adm. No');?></a>
	</th>	
	<th nowrap="nowrap">
		<a href="?m=activity&a=view&activity_id=<?php echo $activity_id;?>&clientorderby=client_first_name" class="hdr"><?php echo $AppUI->_('Client Name');?></a>
	</th>
	<th nowrap="nowrap">
...
{	foreach ($rows as $row)
	{
		...
		$s .= $CR . '<td align="center" nowrap="nowrap">' . $years . '</td>';
		$s .= $CR . '<td align="center" nowrap="nowrap">' . $months . '</td>';
		$s .= $CR . '</tr>';
	}
}
echo "$s\n";
