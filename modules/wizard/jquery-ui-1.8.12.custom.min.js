...
(function (b) {
    ...
    b.fn.tabs = function (d, e) {
        ...
        e = b.extend({
            initial: (d && typeof d == "number" && d > 0) ? --d : 0,
            disabled: null,
            bookmarkable: b.ajaxHistory ? true : false,
            remote: false,
            spinner: "Loading&#8230;",
        ...
        return this.each(function () {
            ...
            if (e.fxAutoHeight) {
                ...
                var j = b("#tabs-watch-font-size").get(0) || b('<span id="tabs-watch-font-size">M</span>').css({
                    display: "block",
                    position: "absolute",
                    visibility: "hidden"
            ...
            var l = {},
                v = {},
                h = e.fxShowSpeed || e.fxSpeed,
                o = e.fxHideSpeed || e.fxSpeed;
...
jQuery.tablesorter.addWidget({ 
	...
	var lheaders=$j(table).data("dheaders");
//      if(!this.headers) { 
        if(!lheaders) { 
            var h = lheaders = [];  
	    ...
	    $j(table).data("dheaders",lheaders);
        }
    } 
});
...
$j.tablesorter.addParser({
        ...
        format: function(s) {
            ...
            return parseInt(s.split("/").reverse().join("")); //s.toLowerCase().replace(/good/,2).replace(/medium/,1).replace(/bad/,0);
        },
