...
<table align="center" border="0" width="500" cellpadding="6" cellspacing="0" class="std">
...
<tr>
	<td colspan ="2" align="center" valign="bottom" nowrap><input type="submit" name="login" value="<?php echo $AppUI->_('login');?>" class="button" /></td>
</tr>
<tr>
